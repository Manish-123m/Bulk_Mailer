"""
Django settings for myemailproject project.
...
SECRET_KEY = 'django-insecure--$!fip!qps73mw4lhbgln_sszr#d@v!3=^q%umbq^0s3cwlum5'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'emailer/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
